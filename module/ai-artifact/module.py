...
def html_viewer(i):
    ...
    if r['return']==0:
       ...
       x+=' to gradually convert various AI artifacts to the <a href="https://github.com/ctuning/ck/wiki/Portable-workflows">common CK format</a>'
...
def show(i):
    ...
    h+=' to gradually convert various AI artifacts to the <a href="https://github.com/ctuning/ck/wiki/Portable-workflows">common CK format</a>'
